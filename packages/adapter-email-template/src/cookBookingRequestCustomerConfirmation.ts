export interface CookBookingBookingRequestCustomerConfirmationInput {
    webAppUrl: string;
...
export function cookBookingRequestCustomerConfirmation({
    webAppUrl,
    customer,
    cook,
    bookingRequest,
    ...
    const customerProfileBookingRequestsUrl: string = webAppUrl + '/de/profile?tab=1';
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class=t15 style="width:398px;padding:0 0 20px 0;">
                                                                        ...
                                                                        <h1 class=t21
                                                                            ...
                                                                            ${customer.firstName}, vielen Dank für deine
                                                                            Buchungsanfrage! 🎉</h1>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class=t126 style="width:600px;padding:0 0 22px 0;">
                                                                        ...
                                                                        <p class=t132 style="margin-bottom:0;Margin-bottom:0;font-family:BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif,'Albert Sans';line-height:22px;font-weight:500;font-style:normal;font-size:14px;text-decoration:none;text-transform:none;letter-spacing:-0.56px;direction:ltr;color:#333333;text-align:left;mso-line-height-rule:exactly;mso-text-raise:2px;">
                                                                            Wir haben deine <span class=t372 style="margin-bottom:0;Margin-bottom:0;color:#FF6433;mso-line-height-rule:exactly;">Anfrage erhalten</span>🧑🏼‍🍳. <span class=t372 style="margin-bottom:0;Margin-bottom:0;color:#FF6433;mso-line-height-rule:exactly;">${
                                                                                cook.firstName
                                                                            }</span> wurde soeben informiert und wird sich innerhalb von <span class=t384 style="margin-bottom:0;Margin-bottom:0;color:#FF6433;mso-line-height-rule:exactly;">48 Std</span>. bei dir melden.
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            ...
                                                            <table class=t310 role=presentation cellpadding=0 cellspacing=0
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class=t311
                                                                        ...
                                                                        <a href="${customerProfileBookingRequestsUrl}" style="
                display: block;
